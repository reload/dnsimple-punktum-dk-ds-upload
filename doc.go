...
- `123456_USERID`: the DK Hostmaster handle you use to login to their self service
- `123456_PASSWORD`: the DK Hostmaster password you use to login to their self service
